...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("ip-blacklist")
        .setDescription("blacklists a certain ip from the proxy")
    ...
    async execute(interaction: CommandInteraction) {
        ...
        return interaction.editReply({
            "embeds": [
                {
                    "title": "ip-blacklist",
                    "description": `\`${ip}\` has been blacklisted from your endpoint`,
                    "color": 7572187,
                    "author": {
