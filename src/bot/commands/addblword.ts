...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setDescription("filters blacklisted words from being sent to the proxy")
            ...
            "embeds": [
                {
                    ...
                    "description": `\`${word}\` has been blacklisted from your endpoint`,
                    "color": 7572187,
                    "author": {
