...
module.exports = {
    ...
    async execute(interaction: CommandInteraction) {
        ...
        if (hook.logs === set) return interaction.editReply({ "content": `enablelogs is already set to ${set}` });
        ...
        return interaction.editReply({
            "embeds": [
                {
                    "title": "enablelogs",
                    "description": `enablelogs has been set to ${set}`,
                    "color": 7572187,
                    "author": {
